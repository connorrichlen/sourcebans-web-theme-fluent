          ...
          {foreach from=$players_banned item=player}
            <tr class="collapse" onclick="{$player.link_url}">
              <td class="text:center">
                <img src="images/games/{$player.icon}" alt="{$player.icon}" title="MOD" border="0" align="absmiddle"/>&nbsp;<i class="fas fa-ban fa-lg"></i>
              </td>
              <td>
                {$player.created}
              </td>
        ...
        <table>
          ...
          <tbody>
            {foreach from=$players_commed item=player}
              <tr class="collapse" onclick="{$player.link_url}">
                <td class="text:center">
                  <img src="images/games/{$player.icon}" alt="{$player.icon}" title="MOD" border="0" align="absmiddle"/>&nbsp;<i class="{$player.type}"></i>
                </td>
                <td>
                  {$player.created}
                </td>
